...
const service = require('../services/tuberiaService');
const router = express.Router();
const FOTOS = [{ name: 'foto_material', maxCount: 1 }, { name: 'foto_instalacion', maxCount: 1 }, { name: 'foto_alineamiento', maxCount: 1 }];
