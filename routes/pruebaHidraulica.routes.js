...
const service = require('../services/pruebaHidraulicaService');
const router = express.Router();
const FOTOS = [{ name: 'foto_antes', maxCount: 1 }, { name: 'foto_durante', maxCount: 1 }, { name: 'foto_despues', maxCount: 1 }];
